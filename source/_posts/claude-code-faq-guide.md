...
![Windows Terminal 设置](/images/claude-code-faq/faq-01.jpeg)

设定默认为管理员权限：

![管理员权限设定](/images/claude-code-faq/faq-02.jpeg)

后续即可右键在所处文件夹内直接打开终端：

![右键打开终端](/images/claude-code-faq/faq-03.png)
...
![WinGet 安装](/images/claude-code-faq/faq-04.jpeg)
...
![PowerShell 7 安装](/images/claude-code-faq/faq-05.jpeg)

安装后切换默认终端为 PowerShell 7：

![切换默认终端](/images/claude-code-faq/faq-06.jpeg)

同样修改其默认配置为管理员启动：

![管理员启动](/images/claude-code-faq/faq-07.png)
...
![Notepad 4 安装](/images/claude-code-faq/faq-08.jpeg)

安装后可通过"系统集成设置"替换系统记事本和快捷打开方式：

![Notepad 4 系统集成](/images/claude-code-faq/faq-09.jpeg)
...
![Git 安装](/images/claude-code-faq/faq-10.jpeg)
...
![fnm 安装](/images/claude-code-faq/faq-11.jpeg)
...
![Node 安装](/images/claude-code-faq/faq-12.jpeg)
...
![Profile 不存在提示](/images/claude-code-faq/faq-13.png)
...
![Profile 文件打开](/images/claude-code-faq/faq-14.jpeg)
...
![fnm env 配置](/images/claude-code-faq/faq-15.jpeg)
...
![Claude Code 安装完成](/images/claude-code-faq/faq-16.jpeg)
...
![字体设置](/images/claude-code-faq/faq-17.png)
...
![Oh My Posh Profile 配置](/images/claude-code-faq/faq-18.jpeg)

![Oh My Posh init](/images/claude-code-faq/faq-19.jpeg)

效果预览：

![Oh My Posh 效果](/images/claude-code-faq/faq-20.png)
...
![Plan Mode 版本说明](/images/claude-code-faq/faq-21.png)
...
![fs_right 错误](/images/claude-code-faq/faq-22.png)
...
![settings.json 配置示意](/images/claude-code-faq/faq-23.png)
...
![--settings 参数](/images/claude-code-faq/faq-24.png)

- 在设置中开启 `Verbose Output` 可恢复详情输出并显示上下文窗口实际值

![Verbose Output 效果](/images/claude-code-faq/faq-25.png)
